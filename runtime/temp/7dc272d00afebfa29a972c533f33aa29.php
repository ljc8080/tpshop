<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:64:"F:\www\pyg\public/../application/home\view\order\settlement.html";i:1570888121;s:51:"F:\www\pyg\application\home\view\Common\layout.html";i:1570882765;}*/ ?>
<!DOCTYPE html>
<html>
...
<div class="cart py-container">
			...
			<div class="step-cont">
				<div class="addressInfo">
					<ul class="addr-detail">
						...
						<li class="addr-item">
							<div class="con name <?php if($v['is_default']==1): ?>selected<?php endif; ?>" address_id='<?php echo $v['id']; ?>'><a
								...
								<div class="modal-body">
									<form action="" class="sui-form form-horizontal" id='address'>
										...
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" class="input-medium" name='area'>
											</div>
											<div class="othername">
												建议填写常用地址：<a href="#" class="sui-btn btn-default">家里</a>　<a href="#"
													class="sui-btn btn-default">父母家</a>　<a href="#"
				...
				<div class="recommendAddr">
					<ul class="addr-detail">
						<li class="addr-item">
							<div class="con name"><a href="javascript:;" class="selected">匹配自提点<span
										title="点击取消选择">&nbsp;</a></div>
				...
				<div class="step-cont">
					<ul class="send-detail">
						<li>
							...
							<div class="sendGoods">
								<span>商品清单：</span>
								<?php if(is_array($goodsinfo) || $goodsinfo instanceof \think\Collection || $goodsinfo instanceof \think\Paginator): $i = 0; $__LIST__ = $goodsinfo;if( count($__LIST__)==0 ) : echo "暂无数据" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
								<ul class="yui3-g">
									<li class="yui3-u-1-6">
										<span><img src="<?php echo $v['goods']['goods_logo']; ?>" /></span>
									</li>
									<li class="yui3-u-7-12">
										<div class="desc"><?php echo $v['goods']['goods_name']; ?><?php echo (isset($v['sku']['value_names']) && ($v['sku']['value_names'] !== '')?$v['sku']['value_names']:''); ?></div>
										<div class="seven">7天无理由退货</div>
									</li>
									<li class="yui3-u-1-12">
										<div class="price"><?php echo (isset($v['sku']['price']) && ($v['sku']['price'] !== '')?$v['sku']['price']:$v['goods']['goods_price']); ?></div>
									</li>
									<li class="yui3-u-1-12">
									...
									<li class="yui3-u-1-12">
										<div class="exit">
											<?php if(isset($v['sku']['store_count'])): if($v['sku']['store_count']-$v['number']>=0): ?>
											有货
											<?php else: ?>
											无货
											<?php endif; else: if($v['goods']['goods_number']-$v['number']>=0): ?>
											有货
											<?php else: ?>
											无货
											<?php endif; endif; ?>
	...
	<div class="order-summary">
		<div class="static fr">
			<div class="list">
				<span><i class="number"><?php echo $num; ?></i>件商品，总商品金额</span>
				<em class="allprice">¥<?php echo $total; ?></em>
			</div>
			<div class="list">
				<span>返现：</span>
	...
	<div class="clearfix trade">
		<div class="fc-price">应付金额:　<span class="price">¥<?php echo $total; ?></span></div>
		<div class="fc-receiverInfo">寄送至:北京市海淀区三环内 中关村软件园9号楼 收货人：某某某 159****3201</div>
	</div>
	<div class="submit" id='pay_order'>
...
<script type="text/javascript">
	$(function () {
		...
		$('#pay_order a').click(function () {
			address_id = $('.addressInfo').find(".selected").attr('address_id');
			$.post("http://www.pyg.com/order/add",
				...
				function (data, textStatus, jqXHR) {
					...
					if (data.code != 200) {
						...
						location.href=  'http://www.pyg.com/pay/index?oid='+data.data
					}
				},
				"json"
			);

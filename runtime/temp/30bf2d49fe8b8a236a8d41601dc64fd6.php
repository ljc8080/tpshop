                                ...
                                <form class="sui-form form-horizontal sui-validate" data-toggle='validate' id="phone-form">
                                    ...
                                    <div class="control-group">
                                     ...
                                     <div class="control-group">
                                        ...
                                        <div class="controls">
												<img src="<?php echo url('usercenter/safe/captcha'); ?>" alt="captcha"  onclick="this.src='<?php echo url('usercenter/safe/captcha'); ?>?'+Math.random()">
                                        </div>
                                    </div>
                                    <div class="control-group">
                                    ...
                                    <div class="control-group next-btn">
                                        <a class="sui-btn btn-primary" href="<?php echo url('usercenter/safe/index',['class'=>'active']); ?>">上一步</a>&nbsp;
                                        <a class="sui-btn btn-primary" type="submit" href="">下一步</a>
                                    </div>
                                </form>
                            </div>
                        </div>

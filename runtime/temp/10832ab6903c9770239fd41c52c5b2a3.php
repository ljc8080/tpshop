<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:64:"F:\www\pyg\public/../application/usercenter\view\safe\index.html";i:1570788027;s:57:"F:\www\pyg\application\usercenter\view\Common\layout.html";i:1570608822;s:60:"F:\www\pyg\application\usercenter\view\Common\left_menu.html";i:1570722445;s:59:"F:\www\pyg\application\usercenter\view\Common\validate.html";i:1570788199;}*/ ?>
<!DOCTYPE html>
<html>
								...
								<div class="control-group">
									...
									<div class="controls">
										<input id="pwdid" class="fn-tinput" data-rule-remote="http://www.baidu.com"
											...
											value="<?php echo \think\Session::get('home_userinfo.nickname'); ?>" disabled='disabled' />
						...
						<div id="two" class="tab-pane">
							...
							<form class="sui-form form-horizontal sui-validate" data-toggle='validate' id="bind-form">
								...
								<div class="control-group">
									...
									<div class="controls fixed">手机验证（<?php echo replace_phone(\think\Session::get('home_userinfo.phone')); ?>）
									</div>
								</div>
								<div class="control-group">
									...
									<div class="controls">
										<img src="<?php echo url('usercenter/safe/captcha'); ?>" alt="captcha"
											onclick="this.src='<?php echo url('usercenter/safe/captcha'); ?>?'+Math.random()">
									</div>
								</div>
								<div class="control-group">
...
<script type="text/javascript" src="/static/home/js/plugins/jquery.validate.js"></script>
<script>
        $(function(){
            //jquery.validate
            $("#phone-form").validate({
...
<script>
	...
	$(function () {
		$class = '<?php echo \think\Request::instance()->param('class'); ?>';
		if ($class) {
		...
		$('#editphone').click(function (e) {
			...
			$.ajax({
				type: "post",
				url: "<?php echo url('usercenter/safe/index'); ?>",
				data: {},
				dataType: "json",
				success: function (response) {
					console.log(response)
					if(response.code==200){
						location.href = "<?php echo url('usercenter/safe/editphone'); ?>"
					}
				}
			});
		})

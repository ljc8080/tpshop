<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:69:"F:\www\pyg\public/../application/home\view\shop_car\success-cart.html";i:1569387138;s:51:"F:\www\pyg\application\home\view\Common\layout.html";i:1570882765;}*/ ?>
<!DOCTYPE html>
<html>
...
<body>
    ...
    <div class="success-cart">
        <div class="py-container ">
            ...
            <div class="goods">
                <div class="left-good">
                    <div class="left-pic"><img src="<?php echo $addCarGood['goods_logo']; ?>"></div>
                    <div class="right-info">
                        <p class="title"><?php echo $addCarGood['goods_name']; ?></p>
                        <p class="attr"><?php echo $addCarGood['value_names']; ?></p>
                    </div>
                </div>
                <div class="right-gocart">
                    <a href="javascript:;" class="sui-btn btn-xlarge">查看商品详情</a>
                    <a href="<?php echo url('home/cart_list/index'); ?>" class="sui-btn btn-xlarge btn-danger " target="_blank">去购物车结算 > </a>
                </div>
            </div>
            </div>
    </div>

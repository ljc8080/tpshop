<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:57:"F:\www\pyg\public/../application/home\view\pay\index.html";i:1569826214;s:51:"F:\www\pyg\application\home\view\Common\layout.html";i:1570882765;}*/ ?>
<!DOCTYPE html>
<html>
...
<div class="cart py-container">
	...
	<div class="checkout py-container  pay">
		<div class="checkout-tit">
			...
			<div class="paymark">
				<span class="fl">请您在提交订单<em
						class="orange time">30分钟</em>之内完成支付，超时订单会自动取消。订单号：<em><?php echo $order['order_sn']; ?></em></span>
		...
		<div class="checkout-steps">
			...
			<div class="step-cont">
				<ul class="payType">
					<?php if(is_array($pay) || $pay instanceof \think\Collection || $pay instanceof \think\Paginator): $i = 0; $__LIST__ = $pay;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
					<li paytype='<?php echo $v['pay_code']; ?>' class="<?php if($i==1): ?>selected<?php endif; ?>"><img src="<?php echo $v['logo']; ?>"></li>
			...
			<div class="submit sui-text-center">
				<a class="sui-btn btn-danger btn-xlarge" href="paysuccess.html" id='payment'>立即支付</a>
			</div>
			<div class="otherpay">
				<div class="step-tit">
					<h5>其他支付方式</h5>
...
<script type="text/javascript">
	$(function () {
		...
		$('#payment').click(function (e) {
			e.preventDefault();
			let type = $('.payType li.selected').attr('paytype');
			let oid = <?php echo $order['id']; ?>;

			$('body').append("<form action='http://www.pyg.com/pay/submit' method='post' id='aa'></form>");
			var html = `<input type='text' name='type' value='${type}'><input type='text' name='oid' value='${oid}'>`
			$('#aa').append(html);
			$("#aa").submit().remove();
			// $.ajax({
			// 	type: "post",
			// 	url: "http://www.pyg.com/pay/submit",
